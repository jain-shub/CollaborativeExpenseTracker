...
@ComponentScan({"com.projects.webdev.dao", "com.projects.webdev.service"})
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setPackagesToScan("com.projects.webdev.model");
    ...
    public HibernateTransactionManager getTransactionManager(){
        ...
        transactionMgr.setSessionFactory(getSessionFactory().getObject());
